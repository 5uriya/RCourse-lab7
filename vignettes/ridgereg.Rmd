...
fitControl <- control <- trainControl(method = "repeatedcv",
 ...
 r <- train(crim ~ ., data = training,method = ridgemodel,preProc = c("scale","center"),
       tuneLength = 10,trControl = fitControl)
````


### 6.Evaluation of Models:
Based o the RMSE values of each model, it is estimated that ridge model is better than lm and leap forward regressions.
